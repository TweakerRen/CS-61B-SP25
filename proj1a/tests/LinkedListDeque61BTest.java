...
public class LinkedListDeque61BTest {
    ...
    public void getRecursiveTest() {
        ...
        assertThat(lld1.getRecursive(26324)).isEqualTo(null);
        assertThat(lld1.getRecursive(0)).isEqualTo(4);
    }
    ...
    public void removeFirstTestBasic() {
        ...
        assertThat(lld1.size()).isEqualTo(0);
        lld1.addFirst("new");  // addFirst after empty
        lld1.removeFirst();
        lld1.addLast("newnew");   // addLast after empty
        assertThat(lld1.get(0)).isEqualTo("newnew");
    }
    ...
    public void toListEmptyTest() {
        ...
        assertThat(deque.toList().isEmpty()).isTrue();
    }
}